...
{
    internal class NewNormsFileParser : FileParser
    {
        public NewNormsFileParser() : base( "New Norms" ) { }
        ...
        public override MusicFile ParseFile( string fileName ) {
            ...
            return new MusicFile( fileName, authors, songName, featurings.Length == 0 ? authors : featurings );
        }
    }
}
